...
import id.twooh.kontak.Model.PostPutDelKontak;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Call<PostPutDelKontak> updateKontakCall = mApiInterface.putKontak( edtId.getText().toString(), edtNama.getText().toString(), edtNomor.getText().toString());
